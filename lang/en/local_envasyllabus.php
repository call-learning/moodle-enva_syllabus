...
$string['syllabuspage:student_total_hours'] = 'Total hours for students';
...
$string['syllabuspage:uc_heures_cm_etudiant'] = 'Lectured courses(CM)';
...
$string['syllabuspage:uc_heures_fmp_etudiant'] = 'Training in work settings (FMP)';
...
$string['syllabuspage:teachers'] = 'Staff';
$string['syllabuspage:competencies'] = 'Target Compentecies';
$string['syllabuspage:prerequisites'] = 'Prerquisites';
